...
if __name__ == "__main__":
    ...
    # 训练数据
    filename = "D:\Pycharm\PycharmProjects\deep_neural_networks_for_youtube_recommendations\dnn\\tfrecords\\train\\train.tfrecords"
    ...
    filename = "D:\Pycharm\PycharmProjects\deep_neural_networks_for_youtube_recommendations\dnn\\tfrecords\evaluation\evaluation.tfrecords"
    writer = tf.python_io.TFRecordWriter(filename)
    i = 0
    for sample in sample_set:
        if i % 10 == 0:
